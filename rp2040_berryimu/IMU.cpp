...
/// @brief Detects which version of the BerryIMU is connected
void detectIMU(){
  printf("\nDetecting...\n");
  ...
  uint8_t LSM9DS0_WHO_AM_I_XM_response;
  uint8_t LSM9DS0_WHO_AM_I_G_response;
  uint8_t LSM9DS1_WHO_M_response;
  uint8_t LSM9DS1_WHO_XG_response;
  uint8_t LSM6DSL_WHO_AM_I_response;
  uint8_t LIS3MDL_WHO_AM_I_response;

  uint8_t WHOresponse;

  //Detect if BerryIMUv1 (Which uses a LSM9DS0) is connected
  //readFrom(LSM9DS0_GYR_ADDRESS, LSM9DS0_WHO_AM_I_G,1,WHOresponse);
  reg_read(FEATHER_DEFAULT_I2C,LSM9DS0_GYR_ADDRESS,LSM9DS0_WHO_AM_I_G,&WHOresponse,2);
  LSM9DS0_WHO_AM_I_G_response = WHOresponse;
  
  //readFrom(LSM9DS0_ACC_ADDRESS, LSM9DS0_WHO_AM_I_XM,1,WHOresponse);
  reg_read(FEATHER_DEFAULT_I2C,LSM9DS0_ACC_ADDRESS,LSM9DS0_WHO_AM_I_XM,&WHOresponse,2);
  LSM9DS0_WHO_AM_I_XM_response = WHOresponse;
